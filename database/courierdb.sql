...
--
INSERT INTO
  `contacts` (`id`, `email`, `subject`, `msg`)
VALUES
  (
    1,
    'love@gmail.com',
    'delay',
    'I have courier 2 weeks ago but its not delivered yet..'
  ),
  (
    2,
    'labh.18is033@cambridge.edu.in',
    'Delay',
    'gjndfjkgnhdfjkgn'
  );
...
VALUES
  (
    ...
    'Boys hostel of Cambridge institute of technology,j',
    2,
    22,
    'cddd.jpeg',
    '2020-12-06'
...
ALTER TABLE
  `adlogin`
ADD
  CONSTRAINT `adlogin_ibfk_1` FOREIGN KEY (`a_id`) REFERENCES `admin` (`a_id`);
...
ALTER TABLE
  `courier`
ADD
  CONSTRAINT `courier_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`) ON DELETE CASCADE;
...
ALTER TABLE
  `login`
ADD
  CONSTRAINT `login_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`) ON DELETE CASCADE;
